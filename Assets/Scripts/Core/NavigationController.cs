...
public class NavigationController : MonoBehaviour {
    ...
    private void Update() {
        if (TargetPosition != Vector3.zero) {
            ...
            DestinationPin.transform.position = new Vector3(DestinationPin.transform.position.x, DestinationPin.transform.position.y, DestinationPin.transform.position.z);
